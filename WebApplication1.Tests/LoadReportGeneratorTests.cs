...
namespace WebApplication1.Tests
{
    ...
    public class LoadReportGeneratorTests
    {
        ...
        public void Two_items_in_the_same_bin_are_averaged_together()
        {
            ...
            var result = LoadReportGenerator.SummarizeByTimeBin(new[]
            {
                new TimeStamped<LoadController.CpuAndRamLoad>(dateTimeOffset,
                    new LoadController.CpuAndRamLoad {CpuLoad = 0.3, RamLoad = 0.5}),
                new TimeStamped<LoadController.CpuAndRamLoad>(dateTimeOffset,
                    new LoadController.CpuAndRamLoad {CpuLoad = 0.2, RamLoad = 0.3}),
            }, start: dateTimeOffset, binSize: TimeSpan.FromHours(1));
